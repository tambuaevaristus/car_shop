          ...
          <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
            <div class="col-lg-4">
              <div class="nav w-100 nav-pills me-4 ">
                <button
                  class="nav-link w-100 rounded-0 d-flex align-items-center text-start p-4 mb-4 text-danger active"
                  data-bs-toggle="pill"
                ...
                <button
                  class="nav-link w-100 rounded-0 d-flex align-items-center text-start p-4 mb-4 text-danger"
                  data-bs-toggle="pill"
                ...
                <button
                  class="nav-link w-100 rounded-0 d-flex align-items-center text-start p-4 mb-0 text-danger"
                  data-bs-toggle="pill"
